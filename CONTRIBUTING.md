...
The following applies to code changes to the Timicoin Core project, and is not to be
confused with overall Timicoin Network Protocol consensus changes.

Whether a pull request is merged into Timicoin Core rests with the project merge
...
Patches that change Timicoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Timicoin consensus, it must have been
