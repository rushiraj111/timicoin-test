...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Timicoin Core timicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  timicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded timicoin transaction") + "\n" +
                               "  timicoin-tx [options] -create [commands]   " + _("Create hex-encoded timicoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded timicoin transaction
