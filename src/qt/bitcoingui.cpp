                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Timicoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Timicoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and timicoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTMC. These actions are disabled at this moment."));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Timicoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Timicoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Timicoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Timicoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Timicoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Timicoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Timicoin Core help message to get a list with possible Timicoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Timicoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Timicoin network", "", count));
}
...
{
    QString strTitle = tr("Timicoin Core"); // default title
