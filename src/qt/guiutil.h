...
/** Utility functions used by the Timicoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Timicoin addresses in monospace font
...
// Parse "timicoin:" URI into recipient object, return true on successful parsing
