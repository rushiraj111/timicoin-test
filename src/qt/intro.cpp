...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Timicoin Core"),
     ...
     * override -datadir in the timicoin.conf file in the default data directory
     * (to be consistent with timicoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
