 ...
 */
    ...
    typeWidget->addItem(tr("Received Tmc from zTmc"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTmc"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTmc));
