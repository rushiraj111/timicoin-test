...
/* Timicoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Timicoin"
#define QAPP_ORG_DOMAIN "timicoin.org"
#define QAPP_APP_NAME_DEFAULT "Timicoin-Qt"
#define QAPP_APP_NAME_TESTNET "Timicoin-Qt-testnet"
