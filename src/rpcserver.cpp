...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Timicoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Timicoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Timicoin features */
        {"timicoin", "masternode", &masternode, true, true, false},
        {"timicoin", "listmasternodes", &listmasternodes, true, true, false},
        {"timicoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"timicoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"timicoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"timicoin", "masternodedebug", &masternodedebug, true, true, false},
        {"timicoin", "startmasternode", &startmasternode, true, true, false},
        {"timicoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"timicoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"timicoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"timicoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"timicoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"timicoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"timicoin", "mnbudget", &mnbudget, true, true, false},
        {"timicoin", "preparebudget", &preparebudget, true, true, false},
        {"timicoin", "submitbudget", &submitbudget, true, true, false},
        {"timicoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"timicoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"timicoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"timicoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"timicoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"timicoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"timicoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"timicoin", "checkbudgets", &checkbudgets, true, true, false},
        {"timicoin", "mnsync", &mnsync, true, true, false},
        {"timicoin", "spork", &spork, true, true, false},
        {"timicoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"timicoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> timicoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:43473/\n";
}
