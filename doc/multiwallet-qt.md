...
In order to support loading of multiple wallets in timicoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is timicoin.cpp.
...
Changes to timicoin.cpp
----------------------
timicoin.cpp is the entry point into timicoin-qt, and as such, will require some minor modifications to provide hooks for
