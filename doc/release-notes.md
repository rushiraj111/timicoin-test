...
Timicoin Core version *version* is now available from:

  <https://github.com/timicoin/timicoin/releases>
...
If you are running an older version, shut it down. Wait until it has completely shut down (which might take a few minutes for older versions), then run the installer (on Windows) or just copy over /Applications/Timicoin-Qt (on Mac) or timicoind/timicoin-qt (on Linux).
...
Timicoin Core should also work on most other Unix-like systems but is not
...
This allows running timicoind without having to do any manual configuration.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/timicoin-project-translations/).
