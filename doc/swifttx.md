...
This mechanism has been integrated into Bitcore-Node-Timicoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/timicoin/insight-api-timicoin#web-socket-api](https://github.com/timicoin/insight-api-timicoin#web-socket-api) 
* API: [https://github.com/timicoin/insight-api-timicoin#swifttx-transactions](https://github.com/timicoin/insight-api-timicoin#swifttx-transactions) 
...
By default, the Timicoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Timicoin Core daemon:
