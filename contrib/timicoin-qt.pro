...
RESOURCES += src/qt/timicoin.qrc src/qt/timicoin_locale.qrc

TRANSLATIONS += src/qt/locale/timicoin_bg.ts \
                src/qt/locale/timicoin_de.ts \
                src/qt/locale/timicoin_en.ts \
                src/qt/locale/timicoin_es.ts \
                src/qt/locale/timicoin_fi.ts \
                src/qt/locale/timicoin_fr.ts \
                src/qt/locale/timicoin_it.ts \
                src/qt/locale/timicoin_ja.ts \
                src/qt/locale/timicoin_pl.ts \
                src/qt/locale/timicoin_pt.ts \
                src/qt/locale/timicoin_ru.ts \
                src/qt/locale/timicoin_sk.ts \
                src/qt/locale/timicoin_sv.ts \
                src/qt/locale/timicoin_vi.ts \
                src/qt/locale/timicoin_zh_CN.ts \
                src/qt/locale/timicoin_zh_TW.ts
