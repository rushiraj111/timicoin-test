...
#   c) node1 mines 32 blocks, so now node 0 has 60001tmc, node 1 has 4250tmc, node2 has none.
#   d) node0 sends 601 tmc to node2, in two transactions (301 tmc, then 300 tmc).
